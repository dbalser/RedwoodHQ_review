...
class CSPBulkTenantActivation{
    public void run(HashMap<String, Object> params){
       
        CSPActivateBulkTenantController controller=new CSPActivateBulkTenantController();
        controller.activateBulkTenants(new CSPWizard());
